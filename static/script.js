...
// search bar Start Here 
  ...
  let pages = [
    ...
    { name: "outfitter", url: "/brand#outfitter" },
    { name: "bareeze", url: "/brand#bareeze" },
    { name: "Nishat Linen", url: "/brand#Nishat Linen" },
    { name: "Alkaram studio", url: "/brand#Alkaram Studio" },
    ...
    //{ name: "khaadi Accessories", url: "/accessories#khaadi Accessories" },
    { name: "Ethnic Accessories", url: "/accessories#Ethnic Accessories" },
    { name: "Nishat Linen Accessories", url: "/accessories#Nishat Linen Accessories" },
    { name: "Alkaram Studio Accessories", url: "/accessories#Alkaram Studio Accessories" },
    { name: "gul ahmed Accessories", url: "/accessories#gul ahmed Accessories" },
    { name: "Lime Light Accessories", url: "/accessories#Lime Light Accessories" },
    { name: "Stylo Accessories", url: "/accessories#Stylo Accessories" },
    { name: "Clive Accessories", url: "/accessories#Clive Accessories" },
    { name: "Metro Accessories", url: "/accessories#Metro Accessories" },
    { name: "MINI Minor Accessories", url: "/accessories#MINI Minor Accessories" },
    // Casual
    ...
    { name: "outfitter", url: "/westmen#outfitter" },
    ...
    { name: "Fauji Foundation hospital", url: "/hospital#Fauji Foundation hospital" },
    { name: "Sarmad Hospital ", url: "/hospital#Sarmad Hospital" },
    { name: "Combined Military Hospital", url: "/hospital#Combined Military Hospital" },
